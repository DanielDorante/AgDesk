 ...
 */
public abstract class Hilt_InventoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InventoryFragment() {
    super();
  }

  Hilt_InventoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InventoryFragment_GeneratedInjector) this.generatedComponent()).injectInventoryFragment(UnsafeCasts.<InventoryFragment>unsafeCast(this));
    }
  }
