...
public abstract class Hilt_AssetsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AssetsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AssetsFragment_GeneratedInjector) this.generatedComponent()).injectAssetsFragment(UnsafeCasts.<AssetsFragment>unsafeCast(this));
    }
  }
