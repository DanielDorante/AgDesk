...
public abstract class Hilt_AddAssetFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddAssetFragment() {
    super();
  }

  Hilt_AddAssetFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAssetFragment_GeneratedInjector) this.generatedComponent()).injectAddAssetFragment(UnsafeCasts.<AddAssetFragment>unsafeCast(this));
    }
  }
