...
public final class ItemDateBinding implements ViewBinding {
  ...
  private ItemDateBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatTextView dateTextView, @NonNull View vieww) {
  ...
  public static ItemDateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.vieww;
      View vieww = ViewBindings.findChildViewById(rootView, id);
      if (vieww == null) {
        break missingId;
      }

      return new ItemDateBinding((ConstraintLayout) rootView, dateTextView, vieww);
    }
